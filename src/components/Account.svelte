...
<a
  href={`/payments`}
  class="p-4 space-y-5 border-b block last:border-none"
  on:click={setAccount}
  >
  <div class="flex">
  ...
  <div class="flex justify-center w-full text-xl">
    <a href={`/invoice`} class="contents" on:click={setAccount}>
      <button class="py-2 px-4 hover:opacity-80 flex grow bg-white">
    ...
    <a href={`/scan`} class="contents" on:click={setAccount}>
      <button class="py-2 px-4 hover:opacity-80 flex shrink bg-white">
        <div class="mx-auto flex gap-2">
    ...
    <a href={`/send`} class="contents grow" on:click={setAccount}>
      <button
                      type="button"
                      class="py-2 px-6 hover:opacity-80 flex bg-white grow"
                      >
