<script>
  ...
  $: if (user)
    menuButtons = [
      ...
      { key: "nav.merch", icon: "shop", href: `https://swapee.shop` },
...
{#if !$loading}
  <header
    class="bg-gradient-to-r dark:!from-violet-600 dark:!to-swapee-purple h-[175px] w-full relative bg-cover mb-20"
