...
const createAndPublishMessageEvent = async (sk: Uint8Array, message: string, userPK: string, recipientPK: string, eventFor: string, expiryDays?: number) => {
    let event;
    if (sk === null) { // Use NIP-07 extension
