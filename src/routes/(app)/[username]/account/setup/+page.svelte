...
<div class="space-y-5">
  ...
  <div class="container w-full mx-auto text-lg px-4 max-w-xl space-y-5">
    <p class="text-secondary mb-1">
      The keys to your savings account are derived from a seed phrase. When
      you're ready, write it down and keep it safe.
    </p>
    ...
    {#if reveal}
      ...
      <div>
        <a href={`/${user.username}/account/setup/step2`} class="contents">
          <button
            type="button"
