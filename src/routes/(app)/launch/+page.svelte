<script>
  ...
  beforeNavigate(({ to }) => {
    if (to?.routeId === "register")
      info("Please sign in so we can get you a ticket");
  });
...
<div class="mx-auto flex items-center justify-center px-8 mt-20">
  <div
    class="flex flex-col w-full bg-white rounded shadow-lg sm:w-3/4 lg:w-3/5"
  >
    <div class="flex flex-col w-full md:flex-row">
      ...
      <div class="p-4 font-normal text-gray-800 md:w-3/4 space-y-5">
        ...
        <p class="leading-normal mb-2">
          ...
          years serving the Vancouver Bitcoin community!
        </p>
        ...
        <p>
          We'll introduce our new interface and then network and enjoy tasty
          food and drinks from <a
        ...
        <p>
          The Loft will be accepting Lightning payments at the event and going
          forward into the future as well! We're charging $6 for for an NFT
          ticket that gets you entry, appies, and the chance to win some swag
          and sats.
        </p>
