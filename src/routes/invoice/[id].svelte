...
{#if $user}
				...
				>
					...
					<div
						class="w-[100%] md:w-auto absolute {showMobileTip
							? 'bottom-0'
							: '-top-full'} bg-white p-6 md:p-0 rounded-t-3xl md:rounded-none transition-all md:transition-none ease-in-out duration-500 left-0 md:static text-center space-y-5"
					>
					...
					<div class="text-center space-y-5">
						...
						<span class="text-secondary block"
							>Scan to pay <a href="/{username}" class="text-black font-semibold">{username}</a
							></span
						>
						...
						<div class="px-5 space-y-3">
							<div class="flex justify-between">
								...
								<span class="font-semibold text-sm"
									...
									<span class="text-secondary font-normal">{`(${amountFormatted} SATS)`}</span
									></span
								>
							</div>
	...
	{:else}
		<div class="text-center mt-20 md:mt-0">
			...
			<button
				class="bg-black text-white rounded-2xl w-20 py-3 font-bold"
